...
export default function SeguimientoRiesgo() {
    ...
    const obtenerEvaluaciones = async () => {
        const evaluacionesAct = await obtenerEvaluacionesActualesProyecto(proyecto.id_proyecto);
        const evaluacionesAnt = await obtenerEvaluacionesAnterioresProyecto(proyecto.id_proyecto);
        const evaluaciones = {
            ...evaluacionesAct,
            ...evaluacionesAnt,
        }
