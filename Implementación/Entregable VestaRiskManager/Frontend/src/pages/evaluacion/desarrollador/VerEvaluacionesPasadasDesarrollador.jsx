...
import { obtenerEvaluacionesActualesProyectoDesarrolladorPaginado, obtenerEvaluacionesAnterioresDesarrolladorProyectoPaginado } from "../../../services/evaluacion";
import { useUsuario } from "../../../context/usuarioContext";

export default function VerEvaluacionesPasadasDesarrollador() {
  ...
  useEffect(() => {
    obtenerEvaluacionesAnterioresDesarrolladorProyectoPaginado(proyecto.id_proyecto, usuario.id_usuario, paginaActual).then(
      (data) => {
                    ...
                    <Button
                      ...
                      onClick={() => {
                        navigate(`/inicio/proyecto/desarrollador/${proyecto.id_proyecto}/monitoreo/evaluacion/${evaluacion.id_evaluacion}`, {
                          state: { ruta: `/inicio/proyecto/desarrollador/${proyecto.id_proyecto}/evaluaciones/pasada` }
                        })
                      }}
                    >
