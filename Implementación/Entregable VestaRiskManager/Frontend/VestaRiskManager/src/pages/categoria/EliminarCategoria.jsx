...
export async function cargarEliminarCategoria({ params }) {
...
export default function EliminarCategoria() {
  ...
  const handleClick = async () => {
    ...
    const resultado = await eliminarCategoria(id_categoria);
      ...
      <>
        ...
        <Contenedor>
          ...
          <>
            ...
            <p>
              ¿Est&aacute; seguro que desea eliminar la categoría{" "}
              <b>{categoria.nombre_categoria}</b>?
            </p>
          </>
          <>
            <Button
